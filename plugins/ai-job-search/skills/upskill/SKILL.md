...
4. Read `profile/candidate.md` to get the candidate's current skills and experience.
...
3. Read `profile/candidate.md` for the candidate's current skills.
...
Remove any skill from the list that is already present in the candidate profile (`profile/candidate.md`). Be generous — if the profile mentions a skill in any form (e.g. "Python" covers "Python scripting"), remove it.
