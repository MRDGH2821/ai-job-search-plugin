...
### Factual accuracy
- [ ] All claims match the candidate's profile (`profile/candidate.md` and `cv/main_example.tex`) - no fabricated skills, experience, or achievements
- [ ] Job titles, dates, company names, and locations are correct
- [ ] Contact details match `profile/candidate.md#identity`
