...
The output file (salary_data.json) will be written to the current directory (your workspace root).
...
def main():
    ...
    parser.add_argument(
        "--output", default=None,
        help="Output JSON file path (default: salary_data.json in the current directory)",
    )
    parser.add_argument(
        "--source", default=None,
