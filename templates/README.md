...
- Activating a template adds a managed block to `profile/cv.md` or `profile/cover-letter.md`, which is what `/apply` reads when drafting and compiling — no other wiring needed.
