...
Fails if any markdown file under plugins/ai-job-search-plugin/skills/job-application-assistant/ (including profile-templates/) is
...
SKILL_DIR = ROOT / "plugins/ai-job-search-plugin/skills/job-application-assistant"
