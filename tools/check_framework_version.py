...
Fails if any markdown file under plugins/ai-job-search/skills/job-application-assistant/ (including profile-templates/) is
...
SKILL_DIR = ROOT / "plugins/ai-job-search/skills/job-application-assistant"
