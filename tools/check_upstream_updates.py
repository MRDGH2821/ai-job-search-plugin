...
3. Compares the 'framework_version' in your local files under
   plugins/ai-job-search-plugin/skills/job-application-assistant/ (including profile-templates/) with those
...
FRAMEWORK_FILES = [
    "plugins/ai-job-search-plugin/skills/job-application-assistant/03-writing-style.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/04-job-evaluation.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/05-cv-templates.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/06-cover-letter-templates.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/07-interview-prep.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/08-application-forms.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/09-web-research.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/10-verification.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/SKILL.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/behavioral.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/candidate.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/cover-letter.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/cv.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/evaluation.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/search-queries.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/star.md",
    "plugins/ai-job-search-plugin/skills/job-application-assistant/profile-templates/writing-patterns.md",
    "AGENTS.md",
]
